  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", color: '#1e293b', maxWidth: '900px' }}>
      ...
      <div style={{ marginBottom: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <h1 style={{ fontSize: '24px', fontWeight: '800', color: '#0f172a', letterSpacing: '-0.5px' }}>Adreslerim</h1>
          <p style={{ color: '#64748b', fontSize: '14px', marginTop: '4px' }}>Teslimat adreslerinizi yönetin.</p>
        </div>
        {!showForm && (
          <button 
            onClick={() => setShowForm(true)}
            style={{ 
              backgroundColor: '#1e40af', color: 'white', border: 'none', padding: '12px 24px', 
      ...
      {/* Address Form */}
      {showForm && (
        <div style={{ backgroundColor: 'white', padding: '32px', borderRadius: '24px', border: '1px solid #f1f5f9', marginBottom: '24px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.02)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
            <h3 style={{ fontSize: '18px', fontWeight: '700', margin: 0 }}>
              <FaMapMarkerAlt style={{ marginRight: 8, color: '#1e40af' }} />
          ...
          <form onSubmit={handleSubmit}>
                ...
                {ADDRESS_LABELS.map(label => (
                  <button
                    ...
                    style={{
                      padding: '8px 16px',
                      borderRadius: '20px',
                      border: form.label === label ? '2px solid #1e40af' : '1px solid #e2e8f0',
                      backgroundColor: form.label === label ? '#eff6ff' : 'white',
                      color: form.label === label ? '#1e40af' : '#64748b',
                      fontWeight: '600',
                      cursor: 'pointer',
                      fontSize: '13px'
                    }}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px' }}>
              <div>
                <label style={labelStyle}>Alıcı Adı Soyadı</label>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px' }}>
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <FaCity style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', color: '#94a3b8' }} />
                  <select 
                    value={form.city} 
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <div style={{ position: 'relative' }}>
                <FaHome style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', color: '#94a3b8' }} />
                <input 
                  type="text" 
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <textarea 
                ...
                style={{ ...inputStyle, paddingLeft: '12px', minHeight: '80px', resize: 'vertical' }} 
            ...
            <div style={{ marginBottom: '24px' }}>
              <label style={labelStyle}>Posta Kodu (Opsiyonel)</label>
              <input 
                type="text" 
                value={form.postal_code} 
                onChange={(e) => setForm({...form, postal_code: e.target.value})} 
                style={{ ...inputStyle, paddingLeft: '12px', maxWidth: '150px' }} 
                placeholder="34000"
              />
            </div>
            ...
            <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
              <button 
                ...
                onClick={resetForm}
                style={{ 
                  backgroundColor: '#f1f5f9', color: '#64748b', border: 'none', padding: '12px 24px', 
          ...
          {addresses.map((address) => (
            <div 
              ...
              style={{ 
                ...
                padding: '24px', 
                borderRadius: '16px', 
                border: address.is_default ? '2px solid #1e40af' : '1px solid #e2e8f0',
                position: 'relative'
              }}
            >
              {address.is_default && (
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  ...
                  <button 
                    ...
                    title="Düzenle"
                    style={{ padding: '8px', backgroundColor: '#eff6ff', color: '#2563eb', border: 'none', borderRadius: '8px', cursor: 'pointer' }}
                  >
                    <FaEdit />
                  </button>
                  <button 
                    ...
                    title="Sil"
                    style={{ padding: '8px', backgroundColor: '#fef2f2', color: '#dc2626', border: 'none', borderRadius: '8px', cursor: 'pointer' }}
                  >
                    <FaTrash />
                  </button>
                </div>
        ...
        !showForm && (
          <div style={{ 
            ...
            <button 
              ...
              style={{ 
                backgroundColor: '#1e40af', color: 'white', border: 'none', padding: '12px 24px', 
                borderRadius: '10px', fontWeight: '600', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '8px'
              }}
            >
