...
export const styles = {
  ...
  toolbar: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', backgroundColor: COLORS.bgSurface, padding: '16px 24px', borderRadius: '16px', boxShadow: COLORS.shadowCard, border: 'none' },
  ...
  sortSelect: { appearance: 'none', backgroundColor: '#F9FAFB', border: `1px solid ${COLORS.border}`, borderRadius: '8px', padding: '10px 36px 10px 16px', fontSize: '14px', fontWeight: '600', color: COLORS.textMain, cursor: 'pointer', outline: 'none' },
...
// --- YARDIMCILAR ---
export const resolveImage = (product) => product?.image || 'https://via.placeholder.com/400x400?text=Urun';
